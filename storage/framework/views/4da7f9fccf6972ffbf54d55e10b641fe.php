...
<body>
    <div class="page-container">
        <div class="container-fluid navbar">
            <a href="/dashboard"><img src="<?php echo e(asset('/images/ligachamp.png')); ?>" alt="" id="logo"></a>
            <div class="nav">
                <ul class="d-flex gap-5 align-items-center" id="nav">
                    ...
                    <li class="dropdown" id="profile">
                        <div class="profile">
                            ...
                            <?php else: ?>
                                <a href="javascript:void(0)"><img
                                        src="<?php echo e(asset('storage/profile/' . auth()->user()->profile_picture)); ?>"
...
<?php /**PATH C:\Users\Kemal Crisannaufal\Documents\Kuliah\Semester 6\ABP-MODUL\maenbal\resources\views/layouts/mainLayout.blade.php ENDPATH**/ ?>